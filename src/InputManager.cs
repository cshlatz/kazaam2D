...
/// <summary>
/// A collection of classes that handle and manage user input to the engine.
/// \details All input is handled by MonoGame's input handling tools. Support for multiple input types have been implemented, including
/// keyboards, gamepads and simulation tools like wheels and joysticks.
/// </summary>
namespace Kazaam.Input
{
    /// <summary>
    /// A class that handles all keyboard and gamepad actions in the game.
    /// </summary>
